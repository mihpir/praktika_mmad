...
class DecisionTree:
    ...
    def fit(self, X, Y, scale, level=0):
        ...
        if scale[max_idx] == CATEGORICAL:
            ...
            for category in categories:
                # рекурсивно вызываем функцию fit с параметрами:
                ...
                self.fit(sub_x, sub_y, scale, level + 1)
        else:
            # столбец числовой
            # рекурсивно вызываем fit для значений, меньше порога, и значений, больше порога
